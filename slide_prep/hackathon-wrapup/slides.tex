...
\node[anchor=north west,inner sep=0] at (.45,7.25) {\includegraphics[width=7.5cm,height=2.8cm,keepaspectratio]{figures/paper-panels/cohort_map_hprc.pdf}};
...
\node[anchor=north west,inner sep=0] at (.5,3.57) {\includegraphics[width=8.45cm,height=2.65cm]{figures/paper-panels/mhc_backbone_large.pdf}};
\node[anchor=north west,inner sep=0] at (9.05,3.57) {\includegraphics[width=6.35cm,height=2.65cm]{figures/paper-panels/classII_drb_large.pdf}};
...
\node[anchor=north west,inner sep=0] at (.15,7.20) {\includegraphics[width=15.55cm,height=5.5cm,keepaspectratio]{figures/paper-panels/variant_improvement.pdf}};
...
\begin{frame}[plain]
\centering
\includegraphics[width=8.5cm,height=8.5cm,keepaspectratio]{figures/dogohla-logo.png}
\end{frame}
\end{document}
